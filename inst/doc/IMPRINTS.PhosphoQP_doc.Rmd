...
You can use the function `imprints_barplotting_peptides` from the package `IMPRINTS.CETSA.app`, 
...
Note that, instead of the 'QP' dataset, you can use an IMPRINTS-CETSA dataset like any `imprints_caldiff_f` output.
