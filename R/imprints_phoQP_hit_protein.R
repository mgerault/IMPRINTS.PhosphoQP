...
#' @param data_diff The output from imprints_caldiff; can also be a path to the data.
...
imprints_phoQP_hit_protein <- function(data, data_diff, ctrl, QP_name = "36C",
  ...
  diff_FC <- tidyr::separate(diff_FC, treatment, into = c("temperature", "replicate", "treatment"), sep = "_")
